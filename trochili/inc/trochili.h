...
#define TCLO_IPC_ISR             (IPC_OPT_ISR)
...
extern TState TclSendMail(TMailBox* pMailbox, TMail* pMail2, TOption option, TTimeTick timeo,
                          TError* pError);
extern TState TclIsrSendMail(TMailBox* pMailbox, TMail* pMail2, TOption option);
...
extern TState TclSendMessage(TMsgQueue* pMsgQue, TMessage* pMsg2, TOption option,
                             TTimeTick timeo, TError* pError);
extern TState TclIsrSendMessage(TMsgQueue* pMsgQue, TMessage* pMsg2, TOption option);
