...
/* 内核IDLE守护线程优先级、时间片和栈大小 */
#define TCLC_IDLE_DAEMON_PRIORITY       (TCLC_LOWEST_PRIORITY)
#define TCLC_IDLE_DAEMON_SLICE          (0xFFFFFFFF)
#define TCLC_IDLE_DAEMON_STACK_BYTES    (512U)
